...
describe('CalculadoraComponent', () => {
  ...
  it('deve garantir que 3 + 2 = 5', () => {
    ...
    let btnCancular = fixture.debugElement.query(By.css('#btnCalcular'));
    let display = fixture.debugElement.query(By.css('#btnCalcular'));
    ...
    btnCancular.triggerEventHandler('click', null);
    fixture.detectChanges();
