...
export class CalculadoraComponent implements OnInit {
  ...
  /**
   * Adiciona o número selecionado para o calculo posteriormente
   * 
   * @param string numero
   * @return void
   */
   ...
   * Caso já possua uma operação seleciona, exeuta a
  ...
  definirOperacao(operacao: string): void {
    //apenas define aoperação caso não exista uma
    if (this.operacao === null) {
      this.operacao = operacao;
      return;
    }
    /* caso operação definida e núemro 2 selecionado,
