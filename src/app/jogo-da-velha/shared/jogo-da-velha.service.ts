...
export class JogoDaVelhaService {
  ...
  /**
   * Retorn se a tela de inicio deve ser exibido.
   * 
   * @return boolean
   */
  ...
  /**
   * Retorna se  tabuleiro deve ser exibido
   * 
   * @return boolean
   */
  ...
  /**
   * Realiza umajogada dado as coordenadas do tabuleiro.
   * 
   * @param number posX
   * @param number posY
   * @return void
  ...
  /**
   * Verifica e retorna se o jogo encerrou
   * 
   * @param number linha
   * @param number coluna
   * @param any tabuleiro
  ...
  /**
   * Obtém uma jogada válida para vitoria de um jogador.
   * 
   * @oaram numberjogador
   * @return number[]
   */
 ...
 */
  ...
  /**
   * Retorna se a marcação de vitoria deve ser exibida para a
   * coordenada informada
   * 
   * @param number posX
   * @param number posY
