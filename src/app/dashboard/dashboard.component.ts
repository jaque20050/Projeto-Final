...
/*
declare = Fazer com uma variavel que esteja globalmente,
no JavaScript, possa ser acesso dentro deste contexto criado,
e compilado pelo TypeScript.
*/
...
export class DashboardComponent implements OnInit {
  ...
  /**
   * Cria e retorna o bjeto DataTable da API de gráficos,
